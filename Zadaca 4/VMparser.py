        ...
        if l[0] == "push":
            if len(l) == 3:
                if l[2].isdigit():
                    ...
                    self._flag = False
                    Parser._error("Parser", n, "Undefined number");
                    return ""
            ...
            if l[0] == "label" and len(l) == 2:
                ...
                if l[1] in self.labels:
                    ...
                    self._flag = False
                    Parser._error("Parser", n, "Undefined label for goto");
                    return ""
                ...
                if l[1] in self.labels:
                    ...
                    self._flag = False
                    Parser._error("Parser", n, "Undefined label for if-goto");
                    return ""
